    ...
    <div id="main-menu" class="main-menu collapse navbar-collapse">
      <ul class="nav navbar-nav">
        ...
        <li class="menu-item-has-children dropdown">
          ...
          <ul class="sub-menu children dropdown-menu">
            <li>
              <i class="menu-icon fa fa-file-text"></i><a href="proses_ahp/kriteria.php">Kriteria</a>
            </li>
            <li>
              <i class="menu-icon fa fa-file-text-o"></i><a href="proses_ahp/alternatif.php">Alternatif</a>
            </li>
            <li>
              <i class="menu-icon fa fa-gear"></i><a href="proses_ahp/analisa_kriteria.php">Analisa Kriteria</a>
            </li>
            <li>
              <i class="menu-icon fa fa-gear"></i><a href="proses_ahp/analisa_alternatif.php">Analisa Alternatif</a>
            </li>
            <li>
              <i class="menu-icon fa fa-gears"></i><a href="proses_ahp/hasil_kriteria.php">Hasil Kriteria</a>
            </li>
            <li>
              <i class="menu-icon fa fa-gears"></i><a href="proses_ahp/hasil_alternatif.php">Hasil Alternatif</a>
            </li>
          </ul>
        </li>
        ...
        <li class="menu-item-has-children dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-file-pdf-o"></i> Laporan</a>
          <ul class="sub-menu children dropdown-menu">
            <li>
